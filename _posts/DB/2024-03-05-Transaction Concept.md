...
1. **Hardware/Software/Transaction Failures**: These can occur due to various reasons such as power outages, system crashes, or errors within the transaction itself. Robust error handling and recovery procedures need to be in place to ensure the integrity of the database.
    ...
    Transaction이 지켜야 하는 4가지 조건
        ...
        ![Untitled]({{"/assets/images/Untitled.png"| relative_url}})
...
![Schedule 8은 V.S하지만 C.S하지 않습니다]({{"/assets/images/Untitled1.png"| relative_url}})

Schedule 8은 V.S하지만 C.S하지 않습니다

![Untitled]({{"/assets/images/Untitled2.png"| relative_url}})

![**Conflict Serializability하지 않고 View Serializability하지 않아도 consistency한 경우도 있습니다.**]({{"/assets/images/Untitled3.png"| relative_url}})
...
![그래프를 그려보았을 때 사이클이 존재한다면 Not conflict serializable]({{"/assets/images/Untitled4.png"| relative_url}})

그래프를 그려보았을 때 사이클이 존재한다면 Not conflict serializable

![사이클이 존재하지 않으므로 conflict serializable]({{"/assets/images/Untitled5.png"| relative_url}})
...
![Untitled]({{"/assets/images/Untitled6.png"| relative_url}})
